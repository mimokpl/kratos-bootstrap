...
require (
	...
	github.com/mimokpl/kratos-bootstrap/config v0.2.2
	github.com/mimokpl/kratos-bootstrap/logger v0.1.2
	github.com/mimokpl/kratos-bootstrap/registry v0.2.2
	github.com/mimokpl/kratos-bootstrap/tracer v0.1.4
