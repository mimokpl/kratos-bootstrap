...
const file_conf_v1_kratos_conf_bootstrap_proto_rawDesc = "" +
	"\n" +
	"#conf/v1/kratos_conf_bootstrap.proto\x12\x04conf\x1a conf/v1/kratos_conf_tracer.proto\x1a\x1econf/v1/kratos_conf_data.proto\x1a conf/v1/kratos_conf_server.proto\x1a conf/v1/kratos_conf_client.proto\x1a conf/v1/kratos_conf_logger.proto\x1a\"conf/v1/kratos_conf_registry.proto\x1a\x1dconf/v1/kratos_conf_oss.proto\x1a conf/v1/kratos_conf_config.proto\x1a conf/v1/kratos_conf_notify.proto\x1a\x1fconf/v1/kratos_conf_authn.proto\x1a\x1fconf/v1/kratos_conf_authz.proto\x1a\x1cconf/v1/kratos_conf_ai.proto\"\x89\x05\n" +
	"\tBootstrap\x12)\n" +
	...
	"R\x05authz\x88\x01\x01\x12\x1d\n" +
	"\x02ai\x18\r \x01(\v2\b.conf.AIH\vR\x02ai\x88\x01\x01B\t\n" +
	"\a_serverB\t\n" +
	"\a_clientB\a\n" +
	"\x05_dataB\b\n" +
	"\x06_traceB\t\n" +
...
var file_conf_v1_kratos_conf_bootstrap_proto_depIdxs = []int32{
	...
	12, // 11: conf.Bootstrap.ai:type_name -> conf.AI
