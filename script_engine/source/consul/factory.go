...
// 用户只需导入即可启用：
//
//	import _ "github.com/mimokpl/kratos-bootstrap/script_engine/source/consul"
//
// YAML 配置示例:
//
//	script:
...
import (
	...
	"github.com/mimokpl/go-scripts/source"
	conf "github.com/mimokpl/kratos-bootstrap/api/gen/go/conf/v1"
	scriptEngine "github.com/mimokpl/kratos-bootstrap/script_engine"
	// TODO: 当 go-scripts/source/consul 发布后，取消注释以下导入
	// consulSource "github.com/mimokpl/go-scripts/source/consul"
)
